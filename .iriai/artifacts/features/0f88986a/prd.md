...
<title>PRD: Charmander ASCII Art Page - System Design</title>
<style>
  /* ── Reset & Base ─────────────────────────────────────────────────── */
...
<h1 class="sd-title">PRD: Charmander ASCII Art Page</h1>
...
<p class="sd-overview-text">A standalone static HTML page that displays a colored Charmander ASCII art illustration. The page uses embedded CSS to render an orange Charmander body with a red flame tail on a dark background. It is a single self-contained `index.html` file with no external dependencies, no JavaScript, and no server — users simply open the file in a browser.</p>
</section>
