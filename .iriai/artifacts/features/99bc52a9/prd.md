...
<title>PRD: Charmander ASCII Art Easter Egg - System Design</title>
<style>
  /* ── Reset & Base ─────────────────────────────────────────────────── */
...
<h1 class="sd-title">PRD: Charmander ASCII Art Easter Egg</h1>
...
<p class="sd-overview-text">A hidden Slack easter egg that responds with Charmander ASCII art and a random fun fact when a user sends a standalone 'charmander' message. This is the platform's first easter egg, adding a touch of personality and delight to the developer experience.</p>
</section>
